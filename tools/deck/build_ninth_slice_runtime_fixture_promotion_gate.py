"""Build the M69-06 ninth-slice runtime fixture promotion gate."""
...
M69_05_VALIDATION = OUTPUT_DIR / "m69_05_ninth_slice_repaired_recipe_validation_report.json"

G_ZONE_OPTION = "main_deck_only_review_no_runtime_promotion"
STRIDE_OPTION = "main_deck_only_review_no_runtime_promotion"
AQUA_FORCE_OPTION = "manual_semantic_review_only_no_runtime_promotion"
...
def _fixture_filename(recipe_id: str, selected_target: dict[str, Any]) -> str:
    return f"{recipe_id}_{_group_slug(str(selected_target.get('group', '')))}_m69_06.json"


def _fixture_id(recipe_id: str, selected_target: dict[str, Any]) -> str:
    return f"runtime_fixture_{recipe_id}_{_group_slug(str(selected_target.get('group', '')))}_m69_06"
...
def build_runtime_fixture(
    ...
    return {
        ...
        "source_artifacts": {
            ...
            "m69_05_repaired_recipe_validation_report": str(M69_05_VALIDATION.relative_to(ROOT)),
        },
        ...
        "count_summary": {
            ...
            "series_counts": dict(count_summary.get("series_counts", {})),
        },
        "source_packages": {
            "selected_review_item_id": accepted_context.get("selected_review_item_id", ""),
            "accepted_combined_repair_package_id": accepted_context.get(
                "accepted_combined_repair_package_id", ""
            ),
            "g_zone_package_id": accepted_context.get("selected_g_zone_package_id", ""),
            "stride_package_id": accepted_context.get("selected_stride_package_id", ""),
            "aqua_force_battle_order_package_id": accepted_context.get(
            ...
            "selected_stride_option_id": system_context.get("selected_stride_option_id", ""),
            "selected_aqua_force_option_id": system_context.get("selected_aqua_force_option_id", ""),
        },
        "system_boundaries": {
            "selected_g_zone_option_id": system_context.get("selected_g_zone_option_id", ""),
            "selected_stride_option_id": system_context.get("selected_stride_option_id", ""),
            ...
            "stride_boundary_applied": bool(system_context.get("stride_boundary_applied")),
            "aqua_force_boundary_applied": bool(system_context.get("aqua_force_boundary_applied")),
...
def build_ninth_slice_runtime_fixture_promotion_gate(
    ...
    checks = [
        _check(
            ...
            and bool(accepted_context.get("repair_accepted"))
            and bool(accepted_context.get("accepted_artifact_ready_for_system_decision"))
            ...
            and bool(accepted_summary.get("ready_for_m69_04")),
            {
                ...
                "validation_repair_accepted": accepted_context.get("repair_accepted"),
                "validation_accepted_artifact_ready": accepted_context.get(
                    "accepted_artifact_ready_for_system_decision"
                ),
                ...
                "accepted_repair_accepted": accepted_summary.get("repair_accepted"),
                "accepted_ready_for_m69_04": accepted_summary.get("ready_for_m69_04"),
                "selected_review_item_id": accepted_context.get("selected_review_item_id", ""),
            },
        ),
        _check(
            "g_zone_stride_aqua_boundary",
            system_context.get("selected_g_zone_option_id") == G_ZONE_OPTION
            and system_context.get("selected_stride_option_id") == STRIDE_OPTION
            and system_context.get("selected_aqua_force_option_id") == AQUA_FORCE_OPTION
            and bool(system_context.get("g_zone_decision_recorded"))
            and bool(system_context.get("stride_decision_recorded"))
            and bool(system_context.get("aqua_force_battle_order_decision_recorded"))
            and bool(system_context.get("main_deck_only_boundary_applied"))
            and bool(system_context.get("g_zone_boundary_applied"))
            and bool(system_context.get("stride_boundary_applied"))
            and bool(system_context.get("aqua_force_boundary_applied"))
            and not bool(system_context.get("g_zone_runtime_enabled"))
            and not bool(system_context.get("stride_runtime_enabled"))
            and not bool(system_context.get("aqua_force_battle_order_runtime_enabled")),
            {
                "selected_g_zone_option_id": system_context.get("selected_g_zone_option_id", ""),
                "selected_stride_option_id": system_context.get("selected_stride_option_id", ""),
                "selected_aqua_force_option_id": system_context.get("selected_aqua_force_option_id", ""),
                "g_zone_decision_recorded": system_context.get("g_zone_decision_recorded"),
                "stride_decision_recorded": system_context.get("stride_decision_recorded"),
                "aqua_force_battle_order_decision_recorded": system_context.get(
                    "aqua_force_battle_order_decision_recorded"
                ),
                ...
                "stride_boundary_applied": system_context.get("stride_boundary_applied"),
                "aqua_force_boundary_applied": system_context.get("aqua_force_boundary_applied"),
                ...
                "aqua_force_battle_order_runtime_enabled": system_context.get(
        ...
        _check(
            ...
            and validation.get("blocker_codes") == []
            and validation.get("review_codes") == []
            ...
            and int(counts.get("grade4_main_deck_count", 0)) == 0,
            {
                ...
                "blocker_codes": validation.get("blocker_codes"),
                "review_codes": validation.get("review_codes"),
        ...
        _check(
            ...
            and not bool(consistency.get("stride_support_deferred"))
            and not bool(consistency.get("aqua_force_battle_order_support_deferred")),
            {
                ...
                "stride_support_deferred": consistency.get("stride_support_deferred"),
                "aqua_force_battle_order_support_deferred": consistency.get(
        ...
        _check(
            ...
            accepted_summary.get("selected_recipe_id") == recipe_id
            and int(sum(row["quantity"] for row in rows)) == 50
            and len(rows) > 0,
            {
                "accepted_recipe_id": accepted_summary.get("selected_recipe_id", ""),
        ...
        _check(
            "rerun_ready",
            bool(summary.get("ready_for_m69_06")),
            {"ready_for_m69_06": summary.get("ready_for_m69_06")},
        ),
        _check(
            "runtime_boundary",
            ...
            and not bool(validation_report["scope"].get("automatic_deck_injection"))
            ...
            and not bool(validation_report["scope"].get("aqua_force_battle_order_runtime_enabled")),
            {
                "m69_05_runtime_fixture_created": summary.get("runtime_fixture_created"),
                "m69_05_runtime_promotion_allowed": summary.get("runtime_promotion_allowed"),
                "m69_05_creates_runtime_fixture": validation_report["scope"].get("creates_runtime_fixture"),
                "m69_05_saved_deck_injection": validation_report["scope"].get("saved_deck_injection"),
                "m69_05_ui_deck_list_publication": validation_report["scope"].get("ui_deck_list_publication"),
                "m69_05_bot_playbook": validation_report["scope"].get("bot_playbook"),
                "m69_05_automatic_deck_injection": validation_report["scope"].get("automatic_deck_injection"),
                "m69_05_direct_GameState_mutation": validation_report["scope"].get("direct_GameState_mutation"),
                "m69_05_g_zone_runtime_enabled": validation_report["scope"].get("g_zone_runtime_enabled"),
                "m69_05_stride_runtime_enabled": validation_report["scope"].get("stride_runtime_enabled"),
                "m69_05_aqua_force_battle_order_runtime_enabled": validation_report["scope"].get(
                    "aqua_force_battle_order_runtime_enabled"
                ),
            },
        ),
    ...
    return {
        "version": "M69-06",
        "description": "Ninth-slice runtime fixture promotion gate",
        "source_inputs": {
            "m69_03_human_accepted_repair_artifact": str(M69_03_ACCEPTED_REPAIR.relative_to(ROOT)),
            "m69_05_repaired_recipe_validation_report": str(M69_05_VALIDATION.relative_to(ROOT)),
        },
        ...
        "gate_policy": {
            ...
            "requires_repair_acceptance": True,
            "requires_main_deck_only_g_zone_boundary": True,
            "requires_main_deck_only_stride_boundary": True,
            "requires_manual_semantic_aqua_force_boundary": True,
            "requires_zero_blockers": True,
            "requires_zero_review_codes": True,
            "requires_combo_consistency": True,
            "requires_m69_05_ready": True,
        ...
        "promotion_decision": {
            ...
            "stride_runtime_enabled": False,
            "aqua_force_battle_order_runtime_enabled": False,
            "next_action": "M69-closeout" if promotion_allowed else "repair_failed_gate_checks",
        },
        ...
        "summary": {
            ...
            "stride_runtime_enabled": False,
            "aqua_force_battle_order_runtime_enabled": False,
            "ready_for_m69_closeout": promotion_allowed,
        },
        "next_target": {
            "milestone": "M69-closeout",
            "task": "Ninth-slice fixture closeout",
        },
    }
...
def write_markdown(report: dict[str, Any], path: Path) -> None:
    ...
    lines = [
        ...
        f"- Ready for M69-closeout: `{summary['ready_for_m69_closeout']}`",
        "",
        "## Gate Checks",
        "",
    ]
    ...
    lines.extend(
        [
            ...
            "## Next",
            "",
            "`M69-closeout`: Ninth-slice fixture closeout.",
            "",
        ]
    )
    path.parent.mkdir(parents=True, exist_ok=True)
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build M69-06 ninth-slice runtime fixture promotion gate.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = build_ninth_slice_runtime_fixture_promotion_gate()
    json_path = args.output_dir / "m69_06_ninth_slice_runtime_fixture_promotion_gate.json"
    md_path = args.output_dir / "m69_06_ninth_slice_runtime_fixture_promotion_gate.md"
    ...
    print(f"M69-06 ninth-slice runtime fixture promotion gate wrote {json_path}")
    print(f"M69-06 ninth-slice runtime fixture promotion gate summary wrote {md_path}")
    if fixture:
        print(f"M69-06 ninth-slice runtime fixture wrote {fixture_path}")
    print(

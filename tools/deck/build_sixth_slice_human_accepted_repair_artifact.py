"""Build the M57-03 sixth-slice human-accepted repair artifact.

This tool consumes the explicit M57-02 selected recipe artifact. It records
...
def _require_acceptance_text(acceptance_text: str) -> str:
    ...
    if not normalized:
        raise ValueError("M57-03 requires non-empty acceptance_text.")
    return normalized
...
def _normalize_removal_sources(
    ...
    for removal in removals:
        ...
        if row.get("card_id") in manual_replacement_ids:
            row["source"] = "m57_03_manual_substitution_preview"
        ...
        rows.append(
            {
                ...
                "source": "m57_03_combined_repair_preview",
            }
        )
    return rows
...
def build_sixth_slice_human_accepted_repair_artifact(
    ...
    *,
    ...
    accepted = bool(selected_artifact.get("summary", {}).get("ready_for_m57_03")) and bool(
    ...
    return {
        "version": "M57-03",
        "description": "Sixth-slice human-accepted repair artifact",
        ...
        "acceptance_policy": {
            "requires_m57_02_selection": True,
        ...
        "acceptance_record": {
            ...
            "source_note": "Recorded from explicit acceptance of the M57-02 selected sixth-slice recipe.",
        },
        "accepted_repair": {
            ...
            "runtime_promotion_allowed": False,
            "requires_m57_04_g_zone_decision": True,
            "requires_m57_05_validation": True,
            "ready_for_m57_04_g_zone_decision": ready_for_m57_04,
        },
        "summary": {
            "accepted_review_item_id": selection["selected_review_item_id"],
            "accepted_recipe_id": selection["recipe_id"],
            ...
            "runtime_promotion_allowed": False,
            "declares_recipe_valid": False,
            "ready_for_m57_04": ready_for_m57_04,
        },
        "next_target": {
            "milestone": "M57-04",
            "task": "Sixth-slice G Zone / Stride decision artifact",
        },
    }
...
def write_markdown(report: dict[str, Any], path: Path) -> None:
    ...
    lines = [
        ...
        f"- Ready for M57-04: `{summary['ready_for_m57_04']}`",
        "",
        "## Acceptance Record",
        "",
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build M57-03 sixth-slice human-accepted repair artifact.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = build_sixth_slice_human_accepted_repair_artifact(
        acceptance_text=args.acceptance_text,
        accepted_by=args.accepted_by,
        accepted_at=args.accepted_at,
    )
    json_path = args.output_dir / "m57_03_sixth_slice_human_accepted_repair_artifact.json"
    md_path = args.output_dir / "m57_03_sixth_slice_human_accepted_repair_artifact.md"
    write_json(report, json_path)
    write_markdown(report, md_path)
    print(f"M57-03 sixth-slice human-accepted repair artifact wrote {json_path}")
    print(f"M57-03 sixth-slice human-accepted repair artifact summary wrote {md_path}")
    print(
        "ready_for_m57_04={ready} accepted_recipe={recipe}".format(
            ready=report["summary"]["ready_for_m57_04"],
            recipe=report["summary"]["accepted_recipe_id"],
        )
    )
    return 0 if report["summary"]["ready_for_m57_04"] else 1

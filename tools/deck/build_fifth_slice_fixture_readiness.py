"""Build fifth-slice fixture/format readiness evidence for M51-02."""
...
def build_fifth_slice_fixture_readiness(selection_report: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        "version": "M51-02",
        "description": "Fifth-slice fixture/format readiness",
        "source_inputs": {
            "fifth_target_slice_selection": str(M51_01_SELECTION.relative_to(ROOT)),
        ...
        "format_scope": {
            ...
            "policy_reuse_decision": "requires_fifth_slice_fixture_scaffold"
            if fixture_expectations_met
            else "requires_fifth_slice_readiness_repair",
        },
        "card_pool_summary": {
        ...
        "next_target": {
            "milestone": "M51-03" if fixture_expectations_met else "M51-repair",
            "task": "Fifth-slice semantic/compatibility probe" if fixture_expectations_met else "Repair fifth-slice readiness blockers",
        },
        "summary": {
            ...
            "all_fixture_expectations_met": fixture_expectations_met,
            "semantic_probe_ready": fixture_expectations_met,
            "ready_for_m51_03": fixture_expectations_met,
            "repair_required": not fixture_expectations_met,
            "repair_reasons": repair_reasons,
        },
    }
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build M51-02 fifth-slice fixture readiness report.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    json_path = args.output_dir / "m51_02_fifth_slice_fixture_readiness.json"
    md_path = args.output_dir / "m51_02_fifth_slice_fixture_readiness.md"
    write_json(report, json_path)
    write_markdown(report, md_path)
    print(f"M51-02 fifth-slice fixture readiness wrote {json_path}")
    print(f"M51-02 fifth-slice fixture readiness summary wrote {md_path}")
    print(
    ...
    return 0 if report["summary"]["ready_for_m51_03"] else 1

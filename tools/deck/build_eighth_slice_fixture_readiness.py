"""Build eighth-slice fixture/format readiness evidence for M63-02."""
...
JSON_OUTPUT = OUTPUT_DIR / "m63_02_eighth_slice_fixture_readiness.json"
MD_OUTPUT = OUTPUT_DIR / "m63_02_eighth_slice_fixture_readiness.md"
...
def build_eighth_slice_fixture_readiness(selection_report: dict[str, Any] | None = None) -> dict[str, Any]:
    selection_report = selection_report or load_json(M63_01_SELECTION)
    selected = selection_report.get("selected_target", {})
    selection_ready = bool(selection_report.get("summary", {}).get("ready_for_m63_02")) and bool(selected)
    ...
    return {
        "version": "M63-02",
        "description": "Eighth-slice fixture/format readiness",
        "source_inputs": {
            "eighth_target_slice_selection": str(M63_01_SELECTION.relative_to(ROOT)),
        ...
        "format_scope": {
            ...
            "policy_reuse_decision": "requires_eighth_slice_fixture_scaffold"
            if fixture_expectations_met
            else "requires_eighth_slice_readiness_repair",
        },
        "card_pool_summary": {
        ...
        "next_target": {
            "milestone": "M63-03" if fixture_expectations_met else "M63-repair",
            "task": "Eighth-slice semantic/compatibility probe"
            if fixture_expectations_met
            else "Repair eighth-slice readiness blockers",
        },
        "summary": {
            ...
            "all_fixture_expectations_met": fixture_expectations_met,
            "semantic_probe_ready": fixture_expectations_met,
            "ready_for_m63_03": fixture_expectations_met,
            "repair_required": not fixture_expectations_met,
            "repair_reasons": repair_reasons,
        },
    }
...
def write_markdown(report: dict[str, Any], path: Path) -> None:
    ...
    lines = [
        "# M63-02 Eighth-Slice Fixture/Format Readiness",
        "",
        "## Selected Target",
        "",
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build M63-02 eighth-slice fixture readiness report.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(f"M63-02 eighth-slice fixture readiness wrote {json_path}")
    print(f"M63-02 eighth-slice fixture readiness summary wrote {md_path}")
    print(
    ...
    return 0 if report["summary"]["ready_for_m63_03"] else 1

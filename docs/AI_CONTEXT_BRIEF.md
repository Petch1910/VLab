...
- Latest M28 Windows gameplay completion status: `M28-01` gameplay completion
  ...
  ready candidates `12`, input issues `2` in the default no-selection report,
  ...
  Python discovery `1860/1860`. `M57-02-batch-preflight-matrix` is complete and
  ...
  created for `m56_recipe_001`, M57-04 recorded

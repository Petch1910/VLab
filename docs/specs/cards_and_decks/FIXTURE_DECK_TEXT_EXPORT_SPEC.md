# Fixture Deck Text Export Spec

Milestone: `M39-02`

## Purpose

`M39-02` exports the accepted offline runtime fixture from `M38/M39-01` into
...
Name: Classic Core Nova Grappler Fixture (recipe_003)
...
- the `M39-01` validation report is missing or not schema-valid
- the fixture is not ready for `M39-02`
...
`M39-02` is done when the deck text, JSON report, and markdown report are

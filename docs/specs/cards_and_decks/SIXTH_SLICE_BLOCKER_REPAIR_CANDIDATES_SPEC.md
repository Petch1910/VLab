# Sixth-Slice Blocker Repair Candidates Spec

Milestone: `M56-06`

## Purpose

`M56-06` creates advisory repair candidates for the sixth-slice Shadow Paladin
G-era recipe blockers found in `M56-04` and carried through `M56-05`.

The report is an offline planning artifact only. It does not change the
`M56-03` recipe drafts, does not accept any repair, and does not promote a
runtime deck.
...
- all `12` blocked recipe drafts have repair items

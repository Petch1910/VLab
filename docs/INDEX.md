...
- `specs/cards_and_decks/SIXTH_SLICE_HUMAN_SELECTION_PREFLIGHT_SPEC.md` M57-02 preflight human selection guard spec
- `../tools/deck/build_sixth_slice_human_selection_preflight.py` M57-02 preflight human selection guard tool
- `../tests/test_sixth_slice_human_selection_preflight.py` M57-02 preflight human selection guard tests
- `../outputs/target_slice/m57_02_sixth_slice_human_selection_preflight.json` M57-02 preflight human selection guard JSON
- `../outputs/target_slice/m57_02_sixth_slice_human_selection_preflight.md` M57-02 preflight human selection guard summary
- `specs/cards_and_decks/SIXTH_SLICE_HUMAN_SELECTION_CANDIDATE_DIGEST_SPEC.md` M57-02 human selection candidate digest spec
- `../tools/deck/build_sixth_slice_human_selection_candidate_digest.py` M57-02 human selection candidate digest tool
- `../tests/test_sixth_slice_human_selection_candidate_digest.py` M57-02 human selection candidate digest tests
...
- `specs/cards_and_decks/SIXTH_SLICE_HUMAN_ACCEPTANCE_REQUEST_PACKET_SPEC.md` M57-03 prerequisite human acceptance request packet spec
- `history/M57_03_HUMAN_ACCEPTANCE_REQUEST_PACKET_CLOSEOUT.md` M57-03 prerequisite human acceptance request packet closeout
- `../tools/deck/build_sixth_slice_human_acceptance_request_packet.py` M57-03 prerequisite human acceptance request packet tool
- `../tests/test_sixth_slice_human_acceptance_request_packet.py` M57-03 prerequisite human acceptance request packet tests
- `../outputs/target_slice/m57_03_sixth_slice_human_acceptance_request_packet.json` M57-03 prerequisite human acceptance request packet JSON
- `../outputs/target_slice/m57_03_sixth_slice_human_acceptance_request_packet.md` M57-03 prerequisite human acceptance request packet summary
- `../outputs/target_slice/m57_03_sixth_slice_human_acceptance_request_packet.csv` M57-03 prerequisite human acceptance request packet CSV
- `specs/cards_and_decks/SIXTH_SLICE_HUMAN_ACCEPTANCE_PREFLIGHT_SPEC.md` M57-03 human acceptance preflight spec
- `history/M57_03_HUMAN_ACCEPTANCE_PREFLIGHT_CLOSEOUT.md` M57-03 human acceptance preflight closeout
- `../tools/deck/build_sixth_slice_human_acceptance_preflight.py` M57-03 human acceptance preflight tool
...
- `specs/cards_and_decks/SEVENTH_SLICE_HUMAN_REPAIR_REVIEW_PACKET_SPEC.md` M61-01 seventh-slice human repair review packet spec
- `../tools/deck/build_seventh_slice_human_repair_review_packet.py` M61-01 seventh-slice human repair review packet tool
- `../tests/test_seventh_slice_human_repair_review_packet.py` M61-01 seventh-slice human repair review packet tests
...
- `specs/cards_and_decks/SEVENTH_SLICE_RUNTIME_FIXTURE_PROMOTION_GATE_SPEC.md` M61-06 seventh-slice runtime fixture promotion gate spec
- `../tools/deck/build_seventh_slice_runtime_fixture_promotion_gate.py` M61-06 seventh-slice runtime fixture promotion gate tool
- `../tests/test_seventh_slice_runtime_fixture_promotion_gate.py` M61-06 seventh-slice runtime fixture promotion gate tests
- `specs/cards_and_decks/SEVENTH_SLICE_FIXTURE_CLOSEOUT_SPEC.md` M61-closeout seventh-slice fixture closeout spec
- `../tools/deck/build_seventh_slice_fixture_closeout.py` M61-closeout seventh-slice fixture closeout tool
- `../tests/test_seventh_slice_fixture_closeout.py` M61-closeout seventh-slice fixture closeout tests
...
- `specs/cards_and_decks/EIGHTH_SLICE_SEMANTIC_COMPATIBILITY_PROBE_SPEC.md` M63-03 eighth-slice semantic/compatibility probe spec
- `../tools/deck/build_eighth_slice_semantic_compatibility_probe.py` M63-03 eighth-slice semantic/compatibility probe tool
- `../tests/test_eighth_slice_semantic_compatibility_probe.py` M63-03 eighth-slice semantic/compatibility probe tests
- `specs/cards_and_decks/EIGHTH_SLICE_RECIPE_PIPELINE_ENTRY_GATE_SPEC.md` M63-04 eighth-slice recipe pipeline entry gate spec
- `../tools/deck/build_eighth_slice_recipe_pipeline_entry_gate.py` M63-04 eighth-slice recipe pipeline entry gate tool
- `../tests/test_eighth_slice_recipe_pipeline_entry_gate.py` M63-04 eighth-slice recipe pipeline entry gate tests
- `specs/cards_and_decks/EIGHTH_SLICE_FIXTURE_SCAFFOLD_SPEC.md` M64-01 eighth-slice fixture scaffold spec
- `../tools/deck/build_eighth_slice_fixture_scaffold.py` M64-01 eighth-slice fixture scaffold tool
- `../tests/test_eighth_slice_fixture_scaffold.py` M64-01 eighth-slice fixture scaffold tests
...
- `specs/cards_and_decks/EIGHTH_SLICE_RECIPE_VALIDATOR_SPEC.md` M64-04 eighth-slice recipe validator spec
- `../tools/deck/validate_eighth_slice_recipe_drafts.py` M64-04 eighth-slice recipe validator tool
- `../tests/test_eighth_slice_recipe_validator.py` M64-04 eighth-slice recipe validator tests
- `specs/cards_and_decks/EIGHTH_SLICE_COMBO_RECIPE_CONSISTENCY_SPEC.md` M64-05 eighth-slice combo-to-recipe consistency spec
- `../tools/deck/check_eighth_slice_combo_recipe_consistency.py` M64-05 eighth-slice combo-to-recipe consistency tool
- `../tests/test_eighth_slice_combo_recipe_consistency.py` M64-05 eighth-slice combo-to-recipe consistency tests
- `specs/cards_and_decks/EIGHTH_SLICE_BLOCKER_REPAIR_CANDIDATES_SPEC.md` M64-06 eighth-slice blocker repair candidates spec
- `../tools/deck/build_eighth_slice_blocker_repair_candidates.py` M64-06 eighth-slice blocker repair candidates tool
- `../tests/test_eighth_slice_blocker_repair_candidates.py` M64-06 eighth-slice blocker repair candidates tests
...
- `specs/cards_and_decks/EIGHTH_SLICE_HUMAN_SELECTED_RECIPE_ARTIFACT_SPEC.md` M65-02 eighth-slice human-selected recipe artifact spec
- `../tools/deck/build_eighth_slice_human_selected_recipe_artifact.py` M65-02 eighth-slice human-selected recipe artifact tool
- `../tests/test_eighth_slice_human_selected_recipe_artifact.py` M65-02 eighth-slice human-selected recipe artifact tests
- `specs/cards_and_decks/EIGHTH_SLICE_HUMAN_ACCEPTED_GRADE_REPAIR_ARTIFACT_SPEC.md` M65-03 eighth-slice human-accepted grade repair artifact spec
- `../tools/deck/build_eighth_slice_human_accepted_grade_repair_artifact.py` M65-03 eighth-slice human-accepted grade repair artifact tool
- `../tests/test_eighth_slice_human_accepted_grade_repair_artifact.py` M65-03 eighth-slice human-accepted grade repair artifact tests
- `specs/cards_and_decks/EIGHTH_SLICE_LOCK_LEGION_DECISION_ARTIFACT_SPEC.md` M65-04 eighth-slice Lock / Legion decision artifact spec
- `../tools/deck/build_eighth_slice_lock_legion_decision_artifact.py` M65-04 eighth-slice Lock / Legion decision artifact tool
- `../tests/test_eighth_slice_lock_legion_decision_artifact.py` M65-04 eighth-slice Lock / Legion decision artifact tests

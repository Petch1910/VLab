...
- Fixture evidence count: `6`
- Passed fixtures: `6`
- Failed fixtures: `0`
- Candidate count: `5`
- Seventh-slice offline pipeline allowed: `True`
- Ready for M59: `True`
...
- `sixth_fixture_shadow_paladin` fixture=`runtime_fixture_m56_recipe_001_shadow_paladin_m57_06` recipe=`m56_recipe_001` unity=`True` actions=`4` events=`4` g_zone_count=`0`
...
- rank `11` group `นารุคามิ` era `link_joker_legion_mate` score `60.17`

## Decision

- Seventh slice selected now: `False`
- Recommended next action: `M59-01 seventh target slice selection`
